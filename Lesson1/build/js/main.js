...
const assignGraded = updateAssignment(student1, { grade: 786 });
...
const assign1 = createNewAssign("typescript tutorial", 88);
const tsAssign = createNewAssign("utility patent", 97);
const assignArg = ["generics", 450];
const newestAssign = createNewAssign(...assignArg);
const fetchUsers = () => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield fetch('https://jsonplaceholder.typicode.com/users').then(response => {
